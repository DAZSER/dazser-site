...
$redpill .= '<a href="mailto:'.$director['email_address'].'">'.$director['email_address'].'</a><br />';
...
$bluepill .= '<img src="/images/'.$location.'/director.jpg" alt="'.$director['name'].', Regional Director" />';
$bluepill .= '</div>';
